...
@include_once('../Core/baseModel.php');
    class RecesamaModel extends BaseModel{
 ...
 */
        ...
        public  function show(){
            $sql = "BEGIN  pkgReceSama.consultaReceSama(:cod_oper,:receptivo,:res); END;";
            $conex = $this->db();
            ...
            while (($row = oci_fetch_array($cursor)) != false) {            
                ...
                $foo[] = new RecesamaModel($row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9],$row[10],$row[11]);
            }
        ...
        public function insert(){
            ...
            $data=array();
            $sql = "BEGIN  pkgReceSama.insertarReceSama(:cod_oper,:receptivo,:cod_hotel,:zona,:hoin_diurno,:hofi_diurno,:hoin_nocturno,:hofi_nocturno,:diurno,:nocturno,:val_recesama,:user_recesama); END;";
            $conex = $this->db();
            $stid = oci_parse($conex, $sql);
            oci_bind_by_name($stid, ':cod_oper',$this->codOperator);
            oci_bind_by_name($stid, ':receptivo',$this->receptivo);
            ...
            oci_bind_by_name($stid, ':val_recesama',$this->value);
            oci_bind_by_name($stid, ':user_recesama',$this->user);
        ...
        function update(){
            $data=array();
            $sql = "BEGIN  pkgReceSama.actualizarReceSama(:cod_oper,:receptivo,:cod_hotel,:zona,:hoin_diurno,:hofi_diurno,:hoin_nocturno,:hofi_nocturno,:diurno,:nocturno,:val_recesama,:user_recesama); END;";
            $conex = $this->db();
            $stid = oci_parse($conex, $sql);
            oci_bind_by_name($stid, ':cod_oper',$this->codOperator);
            oci_bind_by_name($stid, ':receptivo',$this->receptivo);
