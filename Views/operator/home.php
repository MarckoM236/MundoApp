<!-- Formulario -->
<form action="?controller=operator&action=home" method="post">
...
<div class="row justify-content-left py-2">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="Mobile" id="mobile" name="txbMobile">
                           <label class="error" for="mobile" id="phone_error">Campo requerido.</label>
                      </div>
                    </div>
                </div>
              ...
              <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='search'class= "form-control botonesIS" style="width:130px"; type="submit" name="showOperator" value="Buscar" />
                    </div>
                </div>             
                    ...
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        <tr>
                            ...
                            <td><a href="?controller=operator&action=update&code=<?php echo $row['code'];?>"class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                            <td><a onclick="deleteOperator(<?php echo $row['code'];?>)" class="btn btn-danger" ><i class="fa fa-trash-alt" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php }}
                        else{?>
                        <tr>
