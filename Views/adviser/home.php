<!-- Formulario -->
<form action="?controller=adviser&action=home" method="post">
...
<div class="row justify-content-left py-2">
              ...
              <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
               ...
               <div  class="col-lg-2 col-md-3 col-sm-12 col-12 py-1 align-self-center text-left">
			    <div class="row justify-content-left py-2">
				   <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                       <input id='btnSaveAdviser'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
				 </div>
				   <div  class="col-lg-12 col-md-3 col-sm-12 col-12 py-1 align-self-center text-left">
                       <input id='search'class= "form-control botonesIS" style="width:130px"; type="submit" name="showAdviser" value="Buscar" />
				 </div>
			  </div>
                    ...
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        <tr>
                            ...
                            <td><a href="?controller=adviser&action=update&id=<?php echo $row['id'];?>"class="btn btn-warning"><i class="fa fa-edit"></i></a></td>
                            <td><a onclick="deleteAdviser(<?php echo $row['id'];?>)" class="btn btn-danger" ><i class="fa fa-trash-alt" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php }}
                        else{?>
                        <tr>
