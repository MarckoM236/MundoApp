                    ...
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        <tr>
                            ...
                            <td><a href="?controller=estarese&action=update&code=<?php echo $row['code'];?>"class="btn btn-warning"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                            <td><a onclick="deleteEstarese(<?php echo $row['code'];?>)" class="btn btn-danger" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php }}
                        else{?>
                        <tr>
