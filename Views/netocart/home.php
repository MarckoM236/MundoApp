            ...
            <div class="card shadow cuadroHeader " id="cuepoCuadroBusqueda" >
              <div class="row justify-content-left py-2">
                <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-3 align-self-center text-left">
                      <label class="titulosPrincipalesPagina" >Cartagena - Netos</label>
                </div>
  ...
  <hr/>
        ...
        <div class="row justify-content-center py-2">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='btnSaveNetoCart'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
                    </div>
                </div>
                ...
                <!-- <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='search'class= "form-control botonesIS" style="width:130px"; type="submit" name="showNetoCart" value="Buscar" />
                    </div>
                </div>   -->     
...
<hr/>
<!-- results-->
<table id="table" class="table-netoCart ocultar">
  <thead>
                   ...
                   <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-1 align-self-center text-center">
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        //print_r($arr_netocart[1]);
                          
                          for($i=0;$i<count($arr_netocart);$i+=5){?>
                              <tr>
                                <td><?php echo $arr_netocart[$i]['nameHotel']?></td>
                                <td><?php echo $arr_netocart[$i]['nameAlim']?></td>
                                <td><?php echo $arr_netocart[$i]['dateVigIni']?></td>
                                <td><?php echo $arr_netocart[$i]['dateVigFin']?></td>
                                <td><?php echo $arr_netocart[$i]['dateExeIni']?></td>
                                <td><?php echo $arr_netocart[$i]['dateExeIni']?></td>
                                <td><a href="?controller=netocart&action=update&codeH=<?php echo $arr_netocart[$i]['codeHotel'];?>&codeA=<?php echo $arr_netocart[$i]['codeAlim'];?>"class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                            <td><a onclick="deleteNetocart(<?php echo $arr_netocart[$i]['codeHotel'].','.$arr_netocart[$i]['codeAlim'];?>)" class="btn btn-danger" ><i class="fa fa-trash-alt" aria-hidden="true"></i></a></td>
                              </tr>
                        <?php }}
                        else{?>
                        <tr>
...
<hr/>
                ...
                <script type="text/javascript">
                    ...
                    //ocultar tabla
                    $(document).on('click', '#btnAddNetoCart', function (event) {
                    event.preventDefault();
