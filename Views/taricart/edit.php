...
if(isset($arr_taricart)){
    $dateInVi = date_create($arr_taricart[0]['dateVigIni']);
    $div=date_format($dateInVi,"Y-m-d");

    $dateFiVi = date_create($arr_taricart[0]['dateVigFin']);
     $dfv=date_format($dateFiVi,"Y-m-d");

    $dateInEx = date_create($arr_taricart[0]['dateExeIni']);
    $die=date_format($dateInEx,"Y-m-d");

    $dateFiEx = date_create($arr_taricart[0]['dateExeIni']);
...
<!-- Formulario -->
<form action="?controller=taricart&action=home" method="post">
            ...
            <div class="card shadow cuadroHeader " id="cuepoCuadroBusqueda" >
              <div class="row justify-content-left py-2">
                <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-3 align-self-center text-left">
                      <label class="titulosPrincipalesPagina" >Cartagena - Tarifas</label>
                </div>
  ...
  <hr/>
                      ...
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                       ...
                       <!--    <input class="form-control inputFomulario" type="text" placeholder="Estado" id="status" name="txbStatus">-->
                           <select name="txbCodeHotel" id="codeHotel" class="form-select inputFomulario" placeholder="Opciones"> 
                              <option select value="<?php echo $arr_taricart[0]['codeHotel']?>"><?php echo $arr_taricart[0]['nameHotel']?></option>
                              <option value="">-------</option>
                      ...
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                       ...
                       <!--    <input class="form-control inputFomulario" type="text" placeholder="Estado" id="status" name="txbStatus">-->
                           <select name="txbCodeAlim" id="codeAlim" class="form-select inputFomulario" placeholder="Opciones"> 
                              <option select value="<?php echo $arr_taricart[0]['codeAlim']?>"><?php echo $arr_taricart[0]['nameAlim']?></option>
                              <option value="">-------</option>
        ...
        <div class="row justify-content-center py-2">
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueSencilla" name="txbValueSencilla" value="<?php echo $arr_taricart[0]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="vallor" id="valueDoble" name="txbValueDoble" value="<?php echo $arr_taricart[1]['value']?>" >
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueTriple" name="txbValuetriple" value="<?php echo $arr_taricart[2]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueCuadruple" name="txbValueCuadruple" value="<?php echo $arr_taricart[3]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueNino" name="txbValueNino" value="<?php echo $arr_taricart[4]['value']?>">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='btnUpdateTaricart'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
                    </div>
                </div>
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left pad">
                    <div class="row justify-content-left py-2">
                        <input id='btnAddTariCart'class= "form-control botonesIS" style="width:130px"; type="button" value="+" onclick="addSelectTaricart()"/>
                    </div>
                </div>
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                    <input id='cancelUp'class= "form-control botonesIS" style="width:130px"; type="button" value="Cancelar" name="canceltaricart
                    " onclick="cancel('taricart','home')"/>
                </div>             
        </div>
</form>
<hr/>
<!-- results-->
<table id="table" class="table-tariCart ocultar">
  <thead>
...
<hr/>
                ...
                <script type="text/javascript">
                    //******** remove rows from pivot table containing items (Taricart) */
                    ...
                    //mostrar tabla
                    $(document).on('click', '#btnAddTariCart', function (event) {
                    event.preventDefault();
