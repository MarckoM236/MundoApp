  ...
  <hr/>
        ...
        <div class="row justify-content-center py-2">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='btnSaveTaricart'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
                    </div>
                </div>
                ...
                <!-- <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='search'class= "form-control botonesIS" style="width:130px"; type="submit" name="showTaricart" value="Buscar" />
                    </div>
                </div>    -->    
                   ...
                   <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-1 align-self-center text-center">
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        //print_r($arr_taricart[1]);
                          
                          for($i=0;$i<count($arr_taricart);$i+=5){?>
                              <tr>
                                <td><?php echo $arr_taricart[$i]['nameHotel']?></td>
                                <td><?php echo $arr_taricart[$i]['nameAlim']?></td>
                                <td><?php echo $arr_taricart[$i]['dateVigIni']?></td>
                                <td><?php echo $arr_taricart[$i]['dateVigFin']?></td>
