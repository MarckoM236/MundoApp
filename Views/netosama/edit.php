...
if(isset($arr_netosama)){
    $dateInVi = date_create($arr_netosama[0]['dateVigIni']);
    $div=date_format($dateInVi,"Y-m-d");

    $dateFiVi = date_create($arr_netosama[0]['dateVigFin']);
     $dfv=date_format($dateFiVi,"Y-m-d");

    $dateInEx = date_create($arr_netosama[0]['dateExeIni']);
    $die=date_format($dateInEx,"Y-m-d");

    $dateFiEx = date_create($arr_netosama[0]['dateExeIni']);
...
<!-- Formulario -->
<form action="?controller=netosama&action=home" method="post">
            ...
            <div class="card shadow cuadroHeader " id="cuepoCuadroBusqueda" >
              <div class="row justify-content-left py-2">
                <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-3 align-self-center text-left">
                      <label class="titulosPrincipalesPagina" >Actualizar Santa Marta - Netos</label>
                </div>
  ...
  <hr/>
                      ...
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                       ...
                       <!--    <input class="form-control inputFomulario" type="text" placeholder="Estado" id="status" name="txbStatus">-->
                           <select name="txbCodeHotel" id="codeHotel" class="form-select inputFomulario" placeholder="Opciones"> 
                              <option select value="<?php echo $arr_netosama[0]['codeHotel']?>"><?php echo $arr_netosama[0]['nameHotel']?></option>
                              <option value="">-------</option>
                      ...
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                       ...
                       <!--    <input class="form-control inputFomulario" type="text" placeholder="Estado" id="status" name="txbStatus">-->
                           <select name="txbCodeAlim" id="codeAlim" class="form-select inputFomulario" placeholder="Opciones"> 
                              <option select value="<?php echo $arr_netosama[0]['codeAlim']?>"><?php echo $arr_netosama[0]['nameAlim']?></option>
                              <option value="">-------</option>
        ...
        <div class="row justify-content-center py-2">
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueSencilla" name="txbValueSencilla" value="<?php echo $arr_netosama[0]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="vallor" id="valueDoble" name="txbValueDoble" value="<?php echo $arr_netosama[1]['value']?>" >
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueTriple" name="txbValuetriple" value="<?php echo $arr_netosama[2]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueCuadruple" name="txbValueCuadruple" value="<?php echo $arr_netosama[3]['value']?>">
                ...
                <div  class=" col-sm-2 col-2 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left" >
                       ...
                       <div  class="col-lg-12 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                           <input class="form-control inputFomulario" type="text" placeholder="valor" id="valueNino" name="txbValueNino" value="<?php echo $arr_netosama[4]['value']?>">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='btnUpdateNetosama'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
                    </div>
                </div>
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left pad">
                    <div class="row justify-content-left py-2">
                        <input id='btnAddNetoSama'class= "form-control botonesIS" style="width:130px"; type="button" value="+" onclick="addSelectNetosama()"/>
                    </div>
                </div>
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                    <input id='cancelUp'class= "form-control botonesIS" style="width:130px"; type="button" value="Cancelar" name="cancelnetosama
                    " onclick="cancel('netosama','home')"/>
                </div>              
        </div>
</form>
<hr/>
...
<table id="table" class="table-netoSama ocultar">
  ...
  <tbody id="lista-netoSama">
  </tbody>
</table>
<!-- fin results-->
  <?php      

                //print_r($arr_netosama);
                ?>
                <br>
