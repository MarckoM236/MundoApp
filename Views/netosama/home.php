...
<div class="row justify-content-left py-2">
                ...
                <div  class="col-lg-2 col-md-4 col-sm-12 col-12 py-1 align-self-center text-left">
                    <div class="row justify-content-left py-2">
                      <input id='btnSaveNetosama'class= "form-control botonesIS" style="width:130px"; type="button" value="Guardar" />
                    </div>
                </div>
                   ...
                   <div  class="col-lg-12 col-md-12 col-sm-12 col-12 py-1 align-self-center text-center">
                    <div class="table-responsive" >
                      ...
                      <table class="table table-bordered " >
                        ...
                        //print_r($arr_netosama[1]);
                          
                          for($i=0;$i<count($arr_netosama);$i+=5){?>
                              <tr>
                                <td><?php echo $arr_netosama[$i]['nameHotel']?></td>
                                <td><?php echo $arr_netosama[$i]['nameAlim']?></td>
                                <td><?php echo $arr_netosama[$i]['dateVigIni']?></td>
                                <td><?php echo $arr_netosama[$i]['dateVigFin']?></td>
                                <td><?php echo $arr_netosama[$i]['dateExeIni']?></td>
                                <td><?php echo $arr_netosama[$i]['dateExeIni']?></td>
                                <td><a href="?controller=netosama&action=update&codeH=<?php echo $arr_netosama[$i]['codeHotel'];?>&codeA=<?php echo $arr_netosama[$i]['codeAlim'];?>"class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                            <td><a onclick="deleteNetosama(<?php echo $arr_netosama[$i]['codeHotel'].','.$arr_netosama[$i]['codeAlim'];?>)" class="btn btn-danger" ><i class="fa fa-trash-alt" aria-hidden="true"></i></a></td>
                              </tr>
                        <?php }}
                        else{?>
                        <tr>
